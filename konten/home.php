		<h2 id="margin">Video</h2><br/>
<div  class="form5">
	<form action="#" method="get">
		<table>
		<tr>
          	<td><input type="hidden" name="module" value="home" /></td>
			<td><input type="text" name="pencarian" placeholder="ketikan judul video" /></td>
			<td colspan="3" align="center"><button class="btn5 info" type="submit" value="cari" >Cari </button></td>
			</tr>
		</table>
</form>
</div>
...
<!-- IF LOGIN -->
		...
		if(isset($_GET['pencarian'])){
			...
			?>
					<table width="705px" border="0" class="table1" id="margin">
						<tr>
						</tr>
					<?php
