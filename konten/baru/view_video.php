...
<form action="#" method="get">
	<input type="hidden" name="module" value="view_video" />
		<table>      	
   		<tr>
           <td>
              <select type="text" name="id" placeholder="Pilih Kategori" />
              <?php
	        ...
	        <td colspan="3" align="center">
				<button class="btn4 info" type="submit" >Filter </button>
		    </td>	
			<td><input name="username" type="text1"  placeholder="Cari Video" ></td>
                
			<td colspan="3" align="center">
				<button class="btn6 info" type="submit" >Cari </button>
			</td>
		 </tr>
    	</table>
 </form>
