		...
		<h2 id="margin">Daftar Akun Admin</h2>
		<button class="btn info" type="button" value="user" id="margin" onclick="window.location.href='?module=Add_admin#pos'"> Tambah </button>
		...
		?>
				<tr style="text-align: center">
					...
					<td><a href="?module=database/hapus_admin&username=<?php echo $buff['username'];?>">hapus</td>
				</tr>
