...
<div  class="form">
  <h1> Registration </h1>
<form id="contactform" action="?module=database/register" method="post"> 
        
        <td bgcolor="#FFFFFF">
        <table width="452" border="0" align="center" cellpadding="5" cellspacing="0">
        
        <tr>
              <td><p class="contact"><label for="name">Nama</label></p></td>
              <td></td>
        ...
        <tr>
              <td colspan="3" align="center">
				<button class="btn2 info" type="submit" >Sign Up </button>
                <button class="btn2 info" type="button"  onclick="window.location.href='?module=home#pos'"> Batal </button>
              </td>
        </tr>
        </table>
      </td>
